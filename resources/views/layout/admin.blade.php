...
<body class="bg-gray-50 font-sans antialiased min-h-screen flex flex-col">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <a href="{{ route('home') }}" class="text-2xl font-serif font-bold tracking-tight">📚 BiblioAdmin</a>
                </div>
    ...
    <div class="flex flex-1 relative">
        ...
        <aside id="sidebar" class="sidebar-transition fixed inset-y-0 left-0 w-64 bg-white shadow-xl z-40 lg:static lg:shadow-md transform -translate-x-full lg:translate-x-0" aria-label="Barra lateral de navegación">
            ...
            <nav class="p-4 space-y-1" aria-label="Navegación secundaria">
                <!-- Inicio -->
                <a href="{{ route('home') }}" class="flex items-center px-4 py-3 rounded-lg transition {{ request()->routeIs('home') ? 'bg-indigo-50 border-l-4 border-indigo-600 text-indigo-700' : 'text-gray-600 hover:bg-gray-100' }}">
                    <i class="fas fa-home w-6 {{ request()->routeIs('home') ? 'text-indigo-600' : 'text-gray-500' }}"></i>
                ...
                <!-- Categorías -->
                <a href="{{ route('categorias.index') }}" class="flex items-center px-4 py-3 rounded-lg transition {{ request()->routeIs('categorias*') ? 'bg-indigo-50 border-l-4 border-indigo-600 text-indigo-700' : 'text-gray-600 hover:bg-gray-100' }}">
                    <i class="fas fa-tags w-6 {{ request()->routeIs('categorias*') ? 'text-indigo-600' : 'text-gray-500' }}"></i>
                    <span class="ml-3 font-medium">Categorías</span>
                </a>
                
                <!-- Libros -->
                <a href="#" class="flex items-center px-4 py-3 rounded-lg transition {{ request()->routeIs('libros*') ? 'bg-indigo-50 border-l-4 border-indigo-600 text-indigo-700' : 'text-gray-600 hover:bg-gray-100' }}">
                    <i class="fas fa-book w-6 {{ request()->routeIs('libros*') ? 'text-indigo-600' : 'text-gray-500' }}"></i>
                ...
                <!-- Salir (sin estado activo) -->
                <a href="{{ route('logout') }}" class="flex items-center px-4 py-3 rounded-lg transition text-gray-600 hover:bg-gray-100"
    ...
    <script>
        (function() {
            ...
            const sidebarLinks = sidebar?.querySelectorAll('nav a:not([href="{{ route('logout') }}"])');
